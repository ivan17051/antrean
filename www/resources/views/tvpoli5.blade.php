    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
            <div style="padding-left:0;">
              <div class="box box-danger bg-red text-center poli'+data[i]['id']+'" style="font-size:200px;">20<p
                  style="font-size:40px;padding-bottom:30px;">Jainal Abidin</p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="box box-danger">
              <div class="policaption" style="font-size:50px;padding:10px;"> POLI UMUM</div>
      ...
      <div class="col-md-6">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="box box-danger">
              <div class="policaption" style="font-size:50px;padding:10px;"> POLI LANSIA</div>
              <div class="marquee-container">
                <div id="marquee" style="width:max-content;"></div>
              </div>
            </div>
