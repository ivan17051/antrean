...
<div style="height:calc(100vh - 81px);max-height:calc(100vh - 81px);" class="">
  ...
  <div id="viewantrian" style="height:calc(100% - 481px);">
    ...
    <div class="row">
    @for($i=0;$i<2;$i++)
      <div class="col-md-6 my-poli-grid">
        <div class="row">
          <div class="col-md-6">
            <div style="padding-left:0;">
              <div class="box box-danger bg-red text-center poli now" style="font-size:200px;"> - 
              <p class="antrianpolinama" style="font-size:40px;padding-bottom:30px;"> - </p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
...
function setsuara(){
    if (suaraaktif == 1) {
        ...
        sessionStorage.setItem("suaraantrian2", 0);
        suaraaktif = 0;
    } else {
        // $("#tombolsuara").html('<i class="glyphicon glyphicon-volume-up">');
        sessionStorage.setItem("suaraantrian2", 1);
        suaraaktif = 1;
    }
    settombolsuara();
    ceksuara();
...
async function setpoli() {
  ...
  if(sessionStorage.setpoli2 == null){
    ...
    sessionStorage.setItem("setpoli2", listpoli2);
  }
...
function kembali(){
  ...
  sessionStorage.removeItem("setpoli2");
  location.reload();
}
...
$(async function () {
  ...
  if(sessionStorage.setpoli2){
    var poli = sessionStorage.getItem('setpoli2').split(',');
    
    listpoli.push({id:poli[0], nama:poli[1]},{id:poli[2], nama:poli[3]});
    
    setpoli();
  }

  if(sessionStorage.suaraantrian2 == 1){
      suaraaktif = localStorage.getItem("suaraantrian2");
      settombolsuara();
  }

  controlLoopRequestPasien();

  // setInterval(controlLoopRequestPasien, 5000);
});
