            ...
            for (i = 0; i < data.length; i++) {
                ...
                $('#listpoliutama').append('<div class="col-md-4"><div class="box-info">'+
                    ...
                    '<div class="box-info-content">'+
                        ...
                        '<span class="antrianpoli">Antrean berikutnya : <span id="polin'+data[i]['id']+'" style="font-weight: bold;">-</span></span>'+
...
$(function () {
  ...
  setTimeout(getNomor, 4000);
  setTimeout(cekPanggilan, 4000);
});
