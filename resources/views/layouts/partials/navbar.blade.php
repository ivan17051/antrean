                ...
                <ul class="top-nav">
                            ...
                            <div class="listview listview--hover">
                                ...
                                <div class="listview__scroll scrollbar-inner">
                                    <a href="" class="listview__item">
                                        <img src="public/demo/img/profile-pics/1.jpg" class="listview__img" alt="">
                                    ...
                                    <a href="" class="listview__item">
                                        <img src="public/demo/img/profile-pics/2.jpg" class="listview__img" alt="">
                                    ...
                                    <a href="" class="listview__item">
                                        <img src="public/demo/img/profile-pics/3.jpg" class="listview__img" alt="">
                                    ...
                                    <a href="" class="listview__item">
                                        <img src="public/demo/img/profile-pics/4.jpg" class="listview__img" alt="">
                                    ...
                                    <a href="" class="listview__item">
                                        <img src="public/demo/img/profile-pics/5.jpg" class="listview__img" alt="">
                    ...
                    <li class="user hidden-xs-down" style="margin-top:20px;min-width:200px;">
                        <div class="user__info" data-toggle="dropdown">
                            <img class="user__img" src="public/demo/img/profile-pics/4.jpg" alt="">
                            <div>
                                <div class="user__name">{{Auth::user()->username}}</div>
                                <div class="user__email" style="color:#fff;">{{Auth::user()->email}}</div>
                            </div>
                        </div>
